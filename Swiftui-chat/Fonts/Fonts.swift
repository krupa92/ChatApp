...
//  Swiftui-chat
//
//  Created by Krupa Patel on 9/8/2022.
//
...
extension Font {
    ...
    public static var caption: Font {
        ...
        return Font.custom("LexendDeca-Regualr", size: 10)
    }
    
    public static var tabBar: Font {
        
        return Font.custom("LexendDeca-Regualr", size: 12)
    }
    
    public static var settings: Font {
        
        return Font.custom("LexendDeca-Regualr", size: 16)
    }
